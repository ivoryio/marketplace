...
const ArrowLeft = () => (
  <Space mr={3}>
    <Icon alignSelf='center' color='pastel-blue' name='arrow_back' fontSize={5} />
  </Space>
)

const ArrowRight = () => (
  <Space ml={3}>
    <Icon alignSelf='center' color='pastel-blue' name='arrow_forward' fontSize={5} />
  </Space>
)
...
const watches = [
  {
    ...
    imgSrc: 'https://cdn.gearpatrol.com/wp-content/uploads/2018/12/A-Guide-To-Watch-Microbrands-gear-patrol-lead-full.jpg',
  ...
  return (
    <Container>
      <CarouselWrapper id='My Booox' width={{ xs: 1, md: 3 / 4 }}>
        ...
        >
          {watches.map(watch => {
            const { id, title, description, imgSrc, buttonLabel, onClick } = watch
            return (
              <CardWatch
                key={id}
